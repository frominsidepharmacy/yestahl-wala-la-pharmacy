...
raw = json.loads((source / "product.json").read_text(encoding="utf-8"))
prepare_product(Product.from_dict(raw), Path("output/regenerated") / args.publication_key, allow_recent=True)
